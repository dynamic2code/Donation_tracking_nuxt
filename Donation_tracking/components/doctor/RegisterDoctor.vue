                ...
                <form @submit.prevent="submitForm">
                    <div class="form-group">
                        <div class="item">
                            ...
                            <input type="text" id="hospital" v-model="hospital" placeholder="Your Hospital Name" required />                            
                        </div>

                        <div class="item">
                            <label for="first_name" class="normalText">First Name</label>
                            <input type="text" id="first_name" v-model="first_name" placeholder="Your First name" required />                            
                        </div>

                        <div class="item">
                            <label for="second_name" class="normalText">Second Name</label>
                            <input type="text" id="second_name" v-model="second_name" placeholder="The nearest town" required />                            
                        </div>
...
const submitForm = async() =>{
    try {
        const response = await fetch('http://127.0.0.1:8000/api/v1/doctor/', {
          method: 'POST',
          headers: {
