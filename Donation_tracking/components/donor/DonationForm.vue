        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="form-group">
                <div class="item">
                    ...
                    <input type="date" id="date_of_birth" class="alt" v-model="date_of_birth" required/>
                </div>
                <div class="item">
                ...
                <div class="item">
                    ...
                    <input type="date" id="last_donation" class="alt" v-model="last_donation" required/>
                </div>
            </div>
